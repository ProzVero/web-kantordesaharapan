...
$query_warga = "INSERT INTO warga (id_warga, nik_warga, nama_warga, tempat_lahir_warga, tanggal_lahir_warga, jenis_kelamin_warga, alamat_ktp_warga, alamat_warga, desa_kelurahan_warga, kecamatan_warga, kabupaten_kota_warga, provinsi_warga, negara_warga, dusun_warga, rt_warga, rw_warga, agama_warga, pendidikan_terakhir_warga, pekerjaan_warga, status_warga, id_user, created_at, updated_at) VALUES ('$id_warga','$nik', '$nama_kepala_keluarga', '$tempat_lahir_warga', '$tanggal_lahir_warga', '$jenis_kelamin_warga', '$alamat_asal', '$alamat_asal', '-', '-', '-', '-', '-', '$dusun_warga', '$rt_warga', '$rw_warga','-','-','-',
	'$status_warga', '$id_user', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";

//echo $query;

$query_kk= "INSERT INTO kartu_keluarga (id_keluarga, nomor_keluarga, id_kepala_keluarga, alamat_keluarga, dusun_keluarga, desa_kelurahan_keluarga, kecamatan_keluarga, kabupaten_kota_keluarga, provinsi_keluarga, negara_keluarga, rt_keluarga, rw_keluarga, kode_pos_keluarga, id_user, created_at, updated_at) VALUES ($id_keluarga, '$nomor_keluarga', '$id_warga', '$alamat_asal', '-', '-', '-', '-', '-', '-', '-', '-', '-', '$id_user', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";

  $query_mutasi = "INSERT INTO mutasi_masuk (id_warga, id_keluarga, dusun_masuk,rt_masuk,rw_masuk,alamat_asal,tanggal_pindah,alasan_pindah,jenis_kepindahan) VALUES('$id_warga','$id_keluarga','$dusun_warga','$rt_warga','$rw_warga','$alamat_asal','$tanggal_pindah','$alasan_pindah','$jenis_kepindahan');";
