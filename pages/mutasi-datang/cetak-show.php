...
$nomor = 1;
    ...
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, strtoupper($data_mutasi[0]['id_warga']), 0, 1, 'L');

    $pdf->cell(45,7,'Nama',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['nama_warga']),0 , 17), 0, 1, 'L');

    $pdf->cell(45,7,'Tempat Lahir',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, strtoupper($data_mutasi[0]['tempat_lahir_warga']), 0, 1, 'L');

    $pdf->cell(45,7,'Tanggal Lahir',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, ($data_mutasi[0]['tanggal_lahir_warga'] != '0000-00-00') ? date('d-m-Y', strtotime($data_mutasi[0]['tanggal_lahir_warga'])) : '', 0, 1, 'L');

    $pdf->cell(45,7,'Jenis Kelamin',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['jenis_kelamin_warga']), 0, 1), 0, 1, 'L');

    $pdf->cell(45,7,'Agama Warga',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['agama_warga']), 0, 20), 0, 1, 'L');

    $pdf->cell(45,7,'Pendidikan',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['pendidikan_terakhir_warga']), 0, 20), 0, 1, 'L');

    $pdf->cell(45,7,'Pekerjaan',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['pekerjaan_warga']), 0, 20), 0, 1, 'L');

    $pdf->cell(45,7,'Status Tinggal',0,0,'L');
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(80, 7, substr(strtoupper($data_mutasi[0]['status_warga']), 0, 20), 0, 1, 'L');
