...
<table class="table table-striped table-middle">
  <tr>
    ...
    <td width="1%">:</td>
    <td>
      <input type="number" placeholder="NO KK" class="form-control" name="nomor_keluarga" required>
  </tr>
  <tr>
    <th width="20%">Nomor Induk Kependudukan</th>
    <td width="1%">:</td>
    <td>
      <input type="number" placeholder="NIK" class="form-control" name="nik" required>
  </tr>
  <tr>
    <th>Nama</th>
    <td>:</td>
    <td>
      ...
      <input type="text" onkeydown="return /[a-z, ]/i.test(event.key)" placeholder="Nama" class="form-control" name="nama_kepala_keluarga" required>
    </td>
</td>
  </tr>
  <tr>
    <th>Tempat Lahir</th>
    <td>:</td>
    <td><input type="text" onkeydown="return /[a-z, ]/i.test(event.key)" placeholder="Tempat Lahir" class="form-control" name="tempat_lahir_warga" required></td>
  </tr>
  <tr>
    <th>Tanggal Lahir</th>
    <td>:</td>
