...
<table class="table table-striped table-middle">
  <tr>
    ...
    <td width="1%">:</td>
    <td><input type="number" class="form-control" name="nomor_keluarga" minlength="16" maxlength="16" required></td>
  </tr>
  <tr>
...
<table class="table table-striped table-middle">
  ...
  <tr>
    <th>Kode Pos</th>
    <td>:</td>
    <td><input type="number" class="form-control" name="kode_pos_keluarga"></td>
  </tr>
  ...
  <tr>
    <th>Kecamatan</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="kecamatan_keluarga" onkeydown="return /[a-z, ]/i.test(event.key)" required></td>
  </tr>
  <tr>
    <th>Kabupaten/Kota</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="kabupaten_kota_keluarga" onkeydown="return /[a-z, ]/i.test(event.key)" required></td>
  </tr>
  <tr>
    <th>Provinsi</th>
    <td>:</td>
    <td><input type="text" class="form-control" name="provinsi_keluarga" onkeydown="return /[a-z, ]/i.test(event.key)" required></td>
  </tr>
  <tr>
    <th>Negara</th>
    <td>:</td>
