...
$dusun_keluarga = htmlspecialchars($_POST['dusun_keluarga']);
...
$len = strlen($nomor_keluarga);
if ($len != 16) {
	if ($len > 16) {
		echo "<script>window.alert('GAGAL MENYIMPAN!! Nomer Keluarga Lebih..!!'); history.back()</script>";
	}else {
		echo "<script>window.alert('GAGAL MENYIMPAN!! Nomer Keluarga Kurang..!!'); history.back()</script>";
	}
}elseif (
	$id_kepala_keluarga === null || trim($id_kepala_keluarga)==='' || 
	$alamat_keluarga===null || trim($alamat_keluarga)==='' ||
	$dusun_keluarga===null || trim($dusun_keluarga)==='' ||
	$desa_kelurahan_keluarga===null || trim($desa_kelurahan_keluarga)==='' ||
	$kecamatan_keluarga===null || trim($kecamatan_keluarga)==='' ||
	$kabupaten_kota_keluarga===null || trim($kabupaten_kota_keluarga)==='' ||
	$provinsi_keluarga===null || trim($provinsi_keluarga)==='' ||
	$negara_keluarga===null || trim($negara_keluarga)==='' ||
	$rt_keluarga===null || trim($rt_keluarga)==='' ||
	$rw_keluarga===null || trim($rw_keluarga)==='' ||
	$kode_pos_keluarga===null || trim($kode_pos_keluarga)===''
) {
	...
	*/
		...
		$query= "INSERT INTO kartu_keluarga (id_keluarga, nomor_keluarga, id_kepala_keluarga, alamat_keluarga, dusun_keluarga, desa_kelurahan_keluarga, kecamatan_keluarga, kabupaten_kota_keluarga, provinsi_keluarga, negara_keluarga, rt_keluarga, rw_keluarga, kode_pos_keluarga, id_user, created_at, updated_at) VALUES (NULL, '$nomor_keluarga', '$id_kepala_keluarga', '$alamat_keluarga', '$dusun_keluarga','$desa_kelurahan_keluarga', '$kecamatan_keluarga', '$kabupaten_kota_keluarga', '$provinsi_keluarga', '$negara_keluarga', '$rt_keluarga', '$rw_keluarga', '$kode_pos_keluarga', '$id_user', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";
