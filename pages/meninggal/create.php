...
<form action="store.php" method="post">
  ...
  <div class="form-group">
    ...
    <div class="form-group">
       ...
       <div class="col-md-9">
       <span class="help-block">
       <input type="text" class="form-control" name="tempat_kematian" id="tempat_kematian" size="50" placeholder="Tempat Kematian" onkeydown="return /[a-z, ]/i.test(event.key)" /> 
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
    <span class="help-block">
       <input type="text" class="form-control input-md" name="pelapor" id="pelapor" size="30" placeholder="Nama Pelapor Kematian" onkeydown="return /[a-z, ]/i.test(event.key)"/>
