 ...
 function Header()
    {
      ...
      $this->Image('../../assets/img/luwu.png',20,10);
        ...
        // $this->Cell(60);
        // Title
        $this->Cell(200,8,'PEMERINTAH KABUPATEN LUWU',0,1,'C');
        $this->Cell(200,8,'KECAMATAN WALENRANG',0,1,'C');
        $this->Cell(200,8,'DESA HARAPAN',0,1,'C');
        $this->SetFont('Times','',13);
        $this->Cell(200,8,'Jl. Poros Batusitanduk - Rantedamai',0,1,'C');
        // Line break
...
$nomor = 1;
    ...
    $pdf->cell(2,7,':',0,0,'L');
    $pdf->cell(24, 7, strtoupper($data_warga[0]['status_pernikahan']), 0, 1, 'L');
