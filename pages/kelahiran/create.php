...
<label class="col-md-0 control-label" for="="><h4>Data Bayi</h4></label>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
    <span class="help-block">
       <input type="text" class="form-control input-md" name="nama_bayi" id="nama_bayi" size="30" placeholder="Nama Bayi" onkeydown="return /[a-z, ]/i.test(event.key)" required/> 
      <?php # echo form_error('nama_bayi', '<p class="field_error">','</p>')?>  
    </span>
    </div>
    </div>
    ...
    <div class="col-md-9">
    <span class="help-block">
       <input type="number" class="form-control input-md" name="berat_bayi" id="berat_bayi" size="10" placeholder="Berat Bayi (kg)" required/> 
    ...
    <div class="col-md-9">
    <span class="help-block">
       <input type="number" class="form-control input-md" name="panjang_bayi" id="panjang_bayi" size="10" placeholder="Panjang Bayi (cm)" required/> 
  ...
  <legend></legend>
    ...
    <div class="form-group">
       ...
       <div class="col-md-9">
       <span class="help-block">
        <input id="no_kk_sementara" name="no_kk_sementara" type="number" placeholder="No Kepala Keluarga" class="form-control input-md" required="" disabled/>
    ...
    <div class="form-group">
       ...
       <div class="col-md-9">
       <span class="help-block">
       <input type="text" class="form-control" name="nama_ayah" id="nama_ayah" size="50" onkeydown="return /[a-z, ]/i.test(event.key)" placeholder="Nama Ayah"  /> 
    ...
    <div class="form-group">
       ...
       <div class="col-md-9">
       <span class="help-block">
       <input type="text" class="form-control" name="nama_ibu" id="nama_ibu" size="50" onkeydown="return /[a-z, ]/i.test(event.key)" placeholder="Nama Ibu"  /> 
  ...
  <legend></legend>
    ...
    <div class="col-md-9">
    <span class="help-block">
       <input type="text" class="form-control input-md" name="tempat_lahir" id="tempat_lahir" onkeydown="return /[a-z, ]/i.test(event.key)" size="30" placeholder="Tempat Lahir"/> 
    </span>
    ...
    <div class="col-md-9">
    <span class="help-block">
       <input type="text" class="form-control input-md" name="penolong" id="penolong" size="30" placeholder="Nama Penolong Kelahiran" onkeydown="return /[a-z, ]/i.test(event.key)"/>
