...
$query="INSERT INTO tbl_kelahiran (tgl_kelahiran, nama_bayi, jk, berat_bayi, panjang_bayi, nama_ayah, nama_ibu, lokasi_lahir, tempat_lahir, id_keluarga, penolong, id_warga) VALUES ('$tgl_kelahiran','$nama_bayi', '$jk','$berat_bayi','$panjang_bayi','$nama_ayah','$nama_ibu','$lokasi_lahir','$tempat_lahir','$id_keluarga','$penolong','$id_warga')";
