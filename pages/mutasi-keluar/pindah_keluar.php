...
<table class="table table-striped table-middle">
  ...
  <tr>
    <th>Kecamatan</th>
    <td>:</td>
    <td><input type="text" onkeydown="return /[a-z, ]/i.test(event.key)" class="form-control" name="kecamatan_mutasi" required></td>
  </tr>
  <tr>
    <th>Kabupaten/Kota</th>
    <td>:</td>
    <td><input type="text" onkeydown="return /[a-z, ]/i.test(event.key)" class="form-control" name="kabupaten_kota_mutasi" required></td>
  </tr>
  <tr>
    <th>Provinsi</th>
    <td>:</td>
    <td><input type="text" onkeydown="return /[a-z, ]/i.test(event.key)" class="form-control" name="provinsi_mutasi" required></td>
  </tr>
  <tr>
    <th>Negara</th>
    <td>:</td>
    <td><input type="text" onkeydown="return /[a-z, ]/i.test(event.key)" class="form-control" name="negara_mutasi" required></td>
  </tr>
    <tr>
    <th>Dusun</th>
    <td>:</td>
  ...
  <tr>
    <th>Kode Pos</th>
    <td>:</td>
    <td><input type="number" class="form-control" name="kode_pos_mutasi"></td>
  </tr>
</table>
